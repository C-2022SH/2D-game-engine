// WinAPI_test.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    if (FAILED(CCore::GetInstance()->initalize(g_hwnd, POINT{1080, 720})))
    {
        MessageBox(nullptr, L"Core 초기화 실패", L"ERROR", MB_OK);
        return FALSE;
    }
